...
input_folder = '../OC_OD_segmentation/Ground_truth/'
...
od_output_folder = input_folder + '_processed_od_gt/'
...
print("Processing sur les images OC")
...
for i, fichier in enumerate(oc_files):
    ...
    cv2.imwrite(oc_output_folder+fichier[0:13]+'.png', processed_oc_image)
    
print("------------------------------------------")

print("Processing sur les images OD")
...
for i, fichier in enumerate(od_files):
    ...
    cv2.imwrite(od_output_folder+fichier[0:13]+'.png', processed_od_image)
